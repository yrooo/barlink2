...
const DropdownMenuItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & {
    inset?: boolean;
    isButton?: boolean; // Added for custom styling
  }
>(({ className, inset, isButton, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-neutral-100 focus:bg-neutral-200 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      inset && "pl-8",
      isButton && "font-semibold text-black hover:text-main", // Custom button styling
      className
    )}
    {...props}
  />
