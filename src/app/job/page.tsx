                    ...
                    <div key={job._id} className="bg-white p-6 rounded-lg border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:transform hover:translate-y-[-4px] transition-transform">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-xl mb-2 text-blue-600">{job.company}</p>
                          {job.location && <p className="text-lg mb-2 text-gray-600">📍 {job.location}</p>}
                          {job.salary && <p className="text-lg mb-2 text-green-600">💰 {job.salary}</p>}
